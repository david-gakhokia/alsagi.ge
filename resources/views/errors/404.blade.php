...
@section('title', ' გვერდი ვერ მოიძებნა! ')
                ...
                <div class="container">
                    <div class="pag-tp">
                        <div class="pag-tp-inr">
                            <h1 itemprop="headline">გვერდი ვერ მოიძებნა</h1>
                        ...
                        <ol class="breadcrumb brd-rd30 theme-bg">
                            ...
                            <li class="breadcrumb-item active">404 შეცდომა</li>
                        </ol>
                    </div><!-- Page Top -->
                </div>
            </div>
                                ...
                                <div class="srch-fnd-inr error-sec text-center">
                                    <div class="srch-fnd">
                                        <div class="srch-inr mb-3">
                                            ...
                                            <h4 itemprop="headline">უიი, გვერდი ვერ მოიძებნა!</h4>
